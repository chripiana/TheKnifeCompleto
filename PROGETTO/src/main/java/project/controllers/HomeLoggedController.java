...
public class HomeLoggedController {
    ...
    public void visualizzaRistoranti(javafx.event.ActionEvent actionEvent) {
        String ruolo = project.controllers.Navigator.getInstance().getRuoloUtenteLoggato();
    ...
    void handleVediRecensioni(ActionEvent event) {
        project.controllers.Navigator.getInstance().navigateTo("reviews-view.fxml", "Le Mie Recensioni");
    }

    @FXML
    void handleVediPrenotazioni(ActionEvent event) {
        project.controllers.Navigator.getInstance().navigateToReservations();
    }
